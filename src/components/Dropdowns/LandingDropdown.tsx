...
export default function LandingDropdown() {
  ...
  return (
    <>
      <a
        className="px-3 py-2 flex items-center text-xs uppercase font-bold text-white"
        href="#pablo"
        ref={btnDropdownRef}
        onClick={(e) => {
          e.preventDefault()
      ...
      >
        ...
        <Link to="/signin" className="text-sm py-2 px-4 font-normal block w-full whitespace-nowrap bg-transparent text-blueGray-700">
          Login
        </Link>
        <Link to="/signup" className="text-sm py-2 px-4 font-normal block w-full whitespace-nowrap bg-transparent text-blueGray-700">
          Register
        </Link>
        <div className="h-0 mx-4 my-2 border border-solid border-blueGray-100" />
